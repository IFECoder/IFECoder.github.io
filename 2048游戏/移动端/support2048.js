/*底层支撑逻辑*/
var screenWidth = window.screen.availWidth;//获取设备屏幕的宽度
var smallGridWidth = 0.18*screenWidth;
var space = 0.04*screenWidth;
var bigGridWidth = 0.92*screenWidth;

function getPosLeft(i,j) {//获取定位元素的left值
	return space+j*(smallGridWidth+space);
}
function getPosTop(i,j) {//获取定位元素的top值
	return space+i*(smallGridWidth+space);
}
